...
const Food = ({ onClose, food, restId, addToCart, open }) => {
  ...
  // Function to allow background scrolling
  const allowBackgroundScroll = useCallback(() => {
    document.body.style.overflow = '';
    document.body.style.height = '';
  }, []);

  // Effect to handle body scroll when popup opens/closes
  useEffect(() => {
    if (showPopup) {
  ...
  }, [showPopup, preventBackgroundScroll, allowBackgroundScroll]);
