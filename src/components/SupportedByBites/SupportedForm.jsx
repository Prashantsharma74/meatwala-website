...
const SupportedForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // API returns {"success":"1"} or {"success":"0","returnmsg":"Duplicate email"}
      if (String(response?.success) === "1") {
        ...
        // reset with the SAME keys as initial state
        setFormData({
          firstName: "",
          lastName: "",
          phone: "",
        ...
        // Handle duplicate email (or any server-side error message)
        const serverMsg = response?.returnmsg || "Submission failed. Please try again.";
        const isDupEmail =
          typeof serverMsg === "string" &&
          serverMsg.toLowerCase().includes("duplicate email");
