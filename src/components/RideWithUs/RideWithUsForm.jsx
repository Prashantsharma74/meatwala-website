...
const RideWithUsForm = () => {
  ...
  const fullText = (
    <p style={{ fontSize: "13px", margin: 0 }}>
      We use this information exclusively to process and review your application
      to become a courier. By checking this box, you confirm that you have read
      and agree to our{" "}
      <Link
        to="/privacy-policy"
        target="_blank"
  ...
  const validateForm = () => {
    ...
    if (!password) formErrors.password = "Password is required.";
      ...
      formErrors.password = "Password must be at least 10 characters long.";
    ...
    >
      <div className="form-container1">
        <form className="auth-form1" onSubmit={handleSubmit}>
          <h3 className="form-title1">Apply to become a Rider</h3>
