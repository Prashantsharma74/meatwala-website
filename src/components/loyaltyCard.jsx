          ...
          <div className="order-details">
            <div className="d-flex align-items-center justify-content-between w-100">
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexDirection: "column" }}>
                <h6 className="fw-medium dark-text">
                  <span className="fw-normal content-color">Balance : </span>£{parseFloat(item.loyaltipoint).toFixed(2)}
                </h6>
                <div className="mt-3 text-end">
                  <button
                    onClick={() => navigate(`/store/${item.restid}`)}
                    className="btn fw-semibold rounded-3 px-3 py-1"
                    style={{ backgroundColor: "#e84135", color: "white" }}
                  >
                    Shop Now
                  </button>
                </div>
