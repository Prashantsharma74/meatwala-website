...
const Cookie = () => {
  return (
    <>
      ...
      <Navbar />
      <div className="div-t-space mytabb overflow-hidden ">
        <Delivery />
      </div>
      <div
      ...
      >
        <div className="tos-wrapper">
          ...
          <p className="mt-1">
            ...
            .The Meatwala Group Ltd logo, marks, emblems, and images are the copyright of Meatwala Group Ltd, © 2024 All Rights Reserved.
          </p>

          <h2 className="mt-3">WHY DO WE HAVE A COOKIE POLICY?</h2>
          <p className="mt-1">
          ...
          <h2 className="mt-3">WHAT IS A COOKIE?</h2>
          <p className="mt-1">
          ...
          <h2 className="mt-3">WHAT TYPES OF COOKIES DO WE USE?</h2>
          <p className="mt-1">
          ...
          <h2 className="mt-3">Necessary Cookies</h2>
          <p className="mt-1">
          ...
          <h2 className="mt-3">Analytics Cookies</h2>
          <p className="mt-1">
          ...
          <h2 className="mt-3">Marketing/Advertising Cookies</h2>
          <p className="mt-1">
          ...
          <div id="cookie-consent">
            ...
            <h2 className="mt-3">THE COOKIES WE USE</h2>

            <h2 className="mt-2">Google Analytics</h2>
            <p className="mt-1">
            ...
            <h2 className="mt-3">Pixel Cookies and Tags</h2>
            <p className="mt-1">
            ...
            <h2 className="mt-3">Google Ads</h2>
            <p className="mt-1">
            ...
            <h2 className="mt-3">Google Ads Remarketing</h2>
            <p className="mt-1">
            ...
            <h2 className="mt-3">Google Conversion Tracking</h2>
            <p className="mt-1">
