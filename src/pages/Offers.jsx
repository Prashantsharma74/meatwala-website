...
const Offers = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Special Offers on Halal Meat – Discounts & Deals | Meatwala
        </title>
        <meta
          name="description"
          content="Save on Halal meat online with exclusive offers from Meatwala. Enjoy discounts on fresh halal meat delivery near you. Order today!"
        />
      </Helmet>
      <Navbar />
    ...
    <div className="container">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {offeredRestaurant ? (
            <RestaurantCategory
              data={offeredRestaurant?.offerrest}
              text={"Popular Offers"}
              num={"7"}
            />
          ) : (
