                  ...
                  <div className="col-md-12">
                    <div className="address-box white-bg">
                      {supportTicket ? (
                        ...
                        <p>
                            <strong>Order No:</strong> {supportTicket.orderno || "Not Field"}
                          </p>
                          <p>
                            <strong>Title:</strong> {supportTicket.title}
                          </p>
                          <p>
                          ...
                          <p>
                            ...
                            {supportTicket.ticketno}
                          </p>
                          <p>
                            <strong>Ticket Date:</strong> {supportTicket.cdate}
                          </p>
                          ...
                          <div className="chat-box">
                            {supportTicket.suppoertticketdetail
                              .map((detail, index) => (
                                <div
                                  key={index}
                                  className={`chat-message ${detail.isadmin === "1" ? "admin" : "user"}`}
                                >
