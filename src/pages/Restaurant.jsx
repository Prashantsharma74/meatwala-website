...
//   return (
//     <>
//       <Navbar text={"res"} style={{ position: "fixed" }} />
//       <section
...
//                       <div
//                         className="col-lg-3 order-lg-0 order-1"
//                         style={{
...
//                                             cursor: "pointer",
//                                             fontWeight:
//                                               activeCategory === category.category ? "600" : "400",
//                                             color:
//                                               activeCategory === category.category
//                                                 ? "#e84135"
//                                                 : "#333",
...
//                         >
//                           <div
//                             className={`tab-pane fade ${activeButton === 1 ? "show active" : ""
//                               }`}
//                             id="online"
//                             role="tabpanel"
//                             tabIndex={0}
...
//                           <div
//                             className={`tab-pane fade ${activeButton === 2 ? "show active" : ""
//                               }`}
//                             id="overview"
//                             role="tabpanel"
//                             tabIndex={0}
...
//                                   <div className="overview-content mb-3">
//                                     <h5 className="mb-2">
//                                       <i className="fa fa-info-circle" /> Do you have a food allergy?
//                                     </h5>
//                                     <div>
//                                       <p>Some products may contain or come into contact with meat, fish, shellfish, dairy, eggs, nuts, soy, gluten and sesame. Contact the store for allergy details before ordering. We cannot guarantee any product is allergen free. Do not order if you cannot confirm safety.</p>
//                                     </div>
//                                   </div>
...
//                                   <div className="accordion-body" style={{ padding: "0" }}>
//                                     {isLoading ? (
//                                       <div className="text-center py-4 " style={{height:"50vh"}}>
...
//                                 <div className="product-box-section section-b-space">
//                                   {isLoading ? (
//                                     <div className="text-center py-5" style={{height:"50vh"}}>
//                                       <div className="spinner-border text-danger" role="status" style={{ width: "3rem", height: "3rem" }}>
//                                         <span className="visually-hidden">Loading...</span>
//                                       </div>
//                                       <h5 className="mt-3">Loading menu items...</h5>
//                                       <p className="text-muted">Please wait while we fetch the delicious options</p>
//                                     </div>
//                                   ) : filteredFoods.length > 0 ? (
//                                     <div
//                                       data-bs-spy="scroll"
...
//                                       <i className="ri-restaurant-line" style={{ fontSize: "3rem", color: "#ccc", marginBottom: "1rem" }}></i>
...
//                                     <span className="visually-hidden">Loading...</span>
//                                   </div>
//                                   <h5 className="mt-3">Loading restaurant information...</h5>
//                                 </div>
//                               ) : restraDetail?.length > 0 ? (
//                                 restraDetail.map((info, i) => (
//                                   <div className="row" key={i}>
//                                     <div className="col-md-12 col-12">
//                                       <div className="overview-content mb-3">
...
//                                           ))
//                                         ) : (
//                                           <p className="text-muted">No payment methods specified</p>
//                                         )}
//                                       </div>
...
//                                         </h5>
//                                         <ul className="alergy">
//                                           <li>{info?.allergies || "Information not available"}</li>
//                                         </ul>
//                                       </div>
//                                     </div>
...
//                                             <img src={`${rating4}`} style={{ width: 150 }} alt="4 Star Rating" />
//                                           )}
//                                           {(Number(info.hyginerating) === 3 || Number(info.hyginerating) === 3.5) && (
//                                             <img src={`${rating3}`} style={{ width: 150 }} alt="3 Star Rating" />
//                                           )}
//                                           {(Number(info.hyginerating) === 2 || Number(info.hyginerating) === 2.5) && (
//                                             <img src={`${rating2}`} style={{ width: 150 }} alt="2 Star Rating" />
//                                           )}
//                                           {(Number(info.hyginerating) === 1 || Number(info.hyginerating) === 1.5 || info.hyginerating === "") && (
//                                             <img src={`${rating1}`} style={{ width: 150 }} alt="1 Star Rating" />
//                                           )}
//                                           {Number(info.hyginerating) == 5 && (
//                                             <img src={`${rating5}`} style={{ width: 150 }} alt="5 Star Rating" />
//                                           )}
//                                         </div>

//                                         <div>
//                                           <h6>
//                                             Last Inspection {restraDetail[0]?.hygineinspectiondate || "Not available"}
//                                           </h6>
//                                           <p>
//                                             Rating by the Food Standard Agency and our local authority. This rating may have changed
//                                           </p>
//                                           <a
...
//                                       </h5>
//                                       <div className="overview-content mt-0 pl-3 w-100">
//                                         {restraDetail[0]?.lat && restraDetail[0]?.lng ? (
//                                           <Map
//                                             lat={restraDetail[0]?.lat}
//                                             lng={restraDetail[0]?.lng}
//                                           />
...
//                                     <div className="mb-2">
//                                       <h5><span className="me-2">Address: </span>{restraDetail[0]?.location || "Address not specified"}</h5>
//                                     </div>
...
//                                         <span className="me-2">Contact Us:</span>{" "}
//                                         <a
//                                           href={`tel:${info.contactno || "+919999999999"}`}
//                                           data-rel="external"
//                                         >
//                                           <i className="fa fa-phone" /> {info.contactno || "Contact not available"}
//                                         </a>
//                                       </h5>
//                                     </div>
//                                   </div>
...
//                               ) : (
//                                 <div className="text-center py-5">
//                                   <i className="ri-information-line" style={{ fontSize: "3rem", color: "#ccc", marginBottom: "1rem" }}></i>
//                                   <h5>No restaurant information available</h5>
//                                   <p className="text-muted">We couldn't load the restaurant details at this time.</p>
//                                 </div>
//                               )}
//                             </div>
//                           </div>
