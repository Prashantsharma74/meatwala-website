          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-6">
              <div className="">
                ...
                <p className="mt-3">
                  At Meatwala, we believe that business should be a force for
                  good. Every halal meat order you place doesn’t just support
                  your kitchen – it also supports impactful global initiatives
                  that make a real difference to people and communities in need.
                </p>
                <p className="mt-3">
                  Through our commitment to ethical and community-driven halal
                  meat delivery, we help fund social, environmental, and
                  charitable projects around the world. From supporting small
                  businesses and local farming initiatives to contributing to
                  education, clean water access, and sustainable food programs,
                  every purchase helps create long-term, positive change.
                </p>
                <p className="mt-3">
                  By choosing Meatwala as your halal meat supplier, you're not
                  just buying fresh, high-quality meat – you're becoming part of
                  a mission to support communities globally. This is more than
                  just halal meat delivery. It’s halal with purpose.
                </p>
                <p className="mt-3">
                  Together, we’re building a better future – one order at a
                  time.
                </p>
              </div>
            </div>
