      ...
      >
        ...
        <div className="faq-title" style={{ paddingTop: "100px" }}>
          <h2 className="text-black">
            Wholesale Halal Meat for Hotels, Restaurants & Catering
          </h2>
        </div>
        <div className="faq-title">
          ...
          >
            ...
            unbeatable prices. */}
            Get unbeatable trade prices on premium halal meat, custom cuts by
            expert butchers and delivered fast to your hotel, restaurant, or
            catering kitchen.
          </h3>
        </div>
      </section>
            ...
            <div className="col-lg-6">
              <div className="pt-7">
                <h1 style={{ fontSize: 24 }}>
                  Wholesale Halal Meat for Restaurants, Hotels & Catering{" "}
                </h1>
                <p className="mt-2">
                  At Meatwala, we specialise in supplying premium halal meat at
                  wholesale prices to restaurants, hotels, caterers and
                  foodservice businesses across the UK. Whether you're running a
                  busy kitchen, a fine dining venue or organising large scale
                  events, our service is built to deliver fresh, high quality
                  halal meat with consistency, speed and care.
                </p>
                <p className="mt-2">
                  We work with trusted local halal butchers to bring you the
                  very best cuts, expertly prepared and delivered directly to
                  your kitchen. From classic staples like lamb, beef and chicken
                  to specialty items, steaks and BBQ packs. We offer both bulk
                  orders and chefs specific custom cuts to suit every menu and
                  service style.
                </p>
                <p className="mt-2">
                  Our flexible ordering options, competitive trade pricing and
                  commitment to quality make us a preferred partner for food
                  businesses that value reliability and halal integrity. Whether
                  you need a one off delivery or a standing weekly supply, we’ve
                  got you covered with fast delivery, clear pricing and
