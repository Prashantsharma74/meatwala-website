            ...
            <div class="tos-content">
              <div class="tos-main">
                ...
                <div class="tos-section tos-about-us">
                  ...
                  <ul>
                    <li style={{ fontSize: "15px" }} className="mx-4"><p>We are referred to as <strong>"Meatwala"</strong>, <strong>"we"</strong>, <strong>"us"</strong> and <strong>"our"</strong>.</p></li>
                    <li style={{ fontSize: "15px" }} className="mx-4"><p>The Meatwala Group Ltd logo, marks, emblems, and images are the copyright of Meatwala Group Ltd, © 2024 All Rights Reserved.</p></li>
                  </ul>

                  <div class="tos-additional-terms mt-2">
                    <h5 className="fw-bold">Additional Terms Apply:</h5>
                ...
                <div class="tos-section tos-services">
                  ...
                  <div class="tos-text">
                    <p className="mx-4">
                      Meatwala Group Ltd provides on-demand delivery services via a mobile application and website.
                ...
                <div class="tos-section tos-pricing-payment">
                  ...
                  <div class="payment-processing">
                    ...
                    <p className="mx-4">
                      Payment is made directly to Meatwala Group Ltd and passed to partners. We may charge a
                ...
                <footer class="tos-footer">
                  ...
                  <div class="footer-copyright">
                    <p>© 2024 Meatwala Group Ltd. All Rights Reserved.</p>
                  </div>
                </footer>
