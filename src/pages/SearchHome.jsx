...
//     console.log(lat, lng, postcode, "datassssss");
//     try {
//       const storedUser = JSON.parse(localStorage.getItem("user"));
...
//           );
//           console.log("Latitude:", location.lat); // 51.6334472
//           console.log("Longitude:", location.lng); // -0.7777801999999999
//           console.log("Postcode:", postcodeComponent.longName); // HP12
//           return {
...
//         ...existingUserAddress,
//         title: title  // Add the new title value here
//       };
...
//                             handleSearchSubmit(); // Call your existing function
//                           }
//                          }}
//                           style={{
...
//                     //   margin: "10px",  // Add spacing around the box
//                     //   backgroundColor: "#e84135", // Optional: Light background for visual clarity
...
//     await addressAdd(e);
//     setTitle(""); // Clear title state after submission
//     handlebtnclose();
//   }}
// >
//   SUBMIT
