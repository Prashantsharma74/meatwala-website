...
const BlogContact = () => {
  ...
  const getBlogById = async () => {
    try {
      const res = await axios.get(`https://partnermeatwala.com/api/customer/Getblogbyidforcust?blogid=${selectedBlogs.blogid}`)
      setBlog(res.data)
    } catch (error) {
    ...
    <div className="row" style={{marginTop:"90px"}}>
      <div className="col-lg-8 position-relative">
        ...
        <h6 className="text-white">
          Here are some blogs ,so explore our latest blog and enjoy our food.
        </h6>
      </div>
      ...
      <section className="section-b-space">
        ...
        <Link href={`blog-details/${blog.id}`} className="post-box" key={index}>
